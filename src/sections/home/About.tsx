      ...
      <section className="">
        <div className="w-full flex items-center lg:px-20 gap-20 bg-zinc-900">
          ...
          <div className="w-1/2 ">
            ...
            <Link
              to={"/e-learning"}
              className="relative pb-2 text-white text-lg after:content-[''] after:bottom-0 after:h-[5px] after:bg-white after:absolute after:rounded-full hover:after:w-[5px] active:after:w-[15px] after:transition-all after:duration-500 after:left-1/2 after:-translate-x-1/2 text-decoration-line"
            >
              Shop Pants
            </Link>
          </div>
