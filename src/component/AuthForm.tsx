            ...
            <form className="space-y-4 mt-10" onSubmit={handleSubmit}>
                <div className="flex content-start items-start mb-6">
                    <button
                        ...
                        className={`flex-1 py-1 ${isLoginForm
